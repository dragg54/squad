...
import { MdOutlineSettings } from "react-icons/md";const Menu = ({menuContainerOpened, setMenuContainerOpened}) => {
  return (
    <div className={`w-screen h-screen fixed bg-gray-50 ${menuContainerOpened == undefined? 'hidden z-0': menuContainerOpened ? 'block animate-slide-down z-50 top-[0%]':'animate-slide-up block -top-[100%]'}`}>
