...
const CheckMail = () => {
    ...
    return (
        <div className='w-full pt-40 flex flex-col items-center justify-start p-3 h-screen'>
            ...
            <p className="mt-6 text-3xl font-semibold text-center">Check your inbox, please!</p>
            <div className="flex text-xs md:text-base flex-col items-center w-[400px] md:w-[600px] p-3">
                <p className="text-gray-700 mt-6 text-center  flex justify-center">Hey <span className="font-bold ml-1"> {state?.username}</span>, to complete your registration, we need to verify your email.
                     {" We've"} sent a verification link to
                    your email. Please check and confirm {"it's"} really you.</p>
            </div>
            <Button style={'mt-8 !rounded-full !bg-[#b175ff] hover:!bg-purple-700'} name={'Resend'} onClick={() => handleSendEmail()} />
        </div>
    )
}
